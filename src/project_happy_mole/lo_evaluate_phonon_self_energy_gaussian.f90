...
module subroutine isotope_imaginary_selfenergy_gaussian(wp, qp, dr, se, sr, mw, mem, verbosity)
...
module subroutine threephonon_imaginary_selfenergy_gaussian(wp, se, sr, qp, dr, temperature, mw, mem, verbosity)
    !> harmonic properties at this q-point
    type(lo_phonon_dispersions_qpoint), intent(in) :: wp
    !> self-energy
    type(lo_phonon_selfenergy), intent(inout) :: se
