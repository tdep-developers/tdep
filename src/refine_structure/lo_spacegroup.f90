...
use gottochblandat, only: tochar, walltime, lo_clean_fractional_coordinates, lo_chop, lo_frobnorm, lo_invert3x3matrix, lo_determ, &
                          ...
                          lo_general_real_eigenvalues_eigenvectors, lo_triplegemm, lo_cross
use geometryfunctions, only: lo_rotation_matrix_from_axis_and_angle, lo_improper_rotation_matrix_from_axis_and_angle, &
                             lo_rotation_matrix_from_vector_a_to_b, lo_bounding_sphere_of_box
...
type lo_symmetry_group
    !> number of operations
    integer :: n_operation = -lo_hugeint
    !> operations
...
contains
    ...
    procedure, nopass :: generate_pool_of_point_operations
    procedure, nopass :: generate_pool_of_translations
    procedure, nopass :: generate_bruteforce_pool_of_translations
    procedure, nopass :: ensure_point_operations_are_a_group
end type
...
! Interfaces to operation generation
interface
...
interface
    ...
    module subroutine lo_eigenvector_transformation_matrix(gm, rcart, qv, op, inverseoperation)
        ...
        !> position vectors in Cartesian coordinates, generally
        !crystalstructure%rcart
