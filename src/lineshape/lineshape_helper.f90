...
subroutine buffer_spectral_functions(ch, sf2, sf3) !,sigma2,sigma3)
    !> convolution helper
    class(lo_convolution_helper), intent(inout) :: ch
    !> spectral functions for q'
    real(r8), dimension(:, :), intent(in) :: sf2
    !> spectral functions for q''
    real(r8), dimension(:, :), intent(in) :: sf3
    !> smearing parameters for q'
    !real(r8), dimension(:), intent(in) :: sigma2
    !> smearing parameters for q''
    !real(r8), dimension(:), intent(in) :: sigma3
