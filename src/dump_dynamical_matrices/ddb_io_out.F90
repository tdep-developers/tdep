...
!scalars
 ...
 real(8),intent(in) :: dilatmx,ecut,ecutsm,kptnrm,pawecutdg,dfpt_sciss,tolwfr,tphysel
 real(8),intent(in) :: tsmear
...
!arrays
 ...
 real(8),intent(in) :: acell(3),amu(mtypat),kpt(3,mkpt),occ(mband*mkpt)
 real(8),intent(in) :: rprim(3,3),spinat(3,matom),tnons(3,msym),wtk(mkpt)
 real(8),intent(in) :: xred(3,matom),zion(mtypat),znucl(mtypat)
