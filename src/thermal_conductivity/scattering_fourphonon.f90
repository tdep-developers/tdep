        ...
        do b2 = 1, dr%n_mode
            ...
            do b3 = 1, dr%n_mode
                ...
                do b4 = 1, dr%n_mode
                    ...
                    case (6)
                        !sigma = qp%smearingparameter(dr%aq(q3)%vel(:, b3) - dr%aq(q4)%vel(:, b4), dr%default_smearing(b3), smearing)
                        sigma = qp%adaptive_sigma(dr%aq(q3)%vel(:, b3) - dr%aq(q4)%vel(:, b4), dr%default_smearing(b3), smearing)
                    end select
