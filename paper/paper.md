...
affiliations:
  ...
  - name: Department of Physics and Astronomy, Uppsala University, SE-75120 Uppsala, Sweden
    index: 9
date: 2023
bibliography: literature_final.bib
---
...
Here we list the most important codes that are shipped with the TDEP package, explain their purpose, and list the respective references in the literature. A more detailed explanation of all features can be found in the online documentation.
...
- `lineshape`: Compute phonon spectral functions including lifetime broadening and shifts for single q-points, q-point meshes, or q-point paths in the Brillouin zone [@Romero.2015; @Shulumba.2017]. The grid mode computes _spectral_ thermal transport properties [@Dangic.2021].
