...
The TDEP code delivers a clean and fast Fortran implementation with message passing interface (MPI) parallelism for these methods. This allows for materials simulations of systems ranging from simple elemental solids up to complex compounds with reduced symmetry.
